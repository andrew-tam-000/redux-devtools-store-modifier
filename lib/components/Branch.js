...
var Branch = function (_Component) {
    ...
    _createClass(Branch, [{
        ...
        value: function render() {
            ...
            var labelClassname = ['state__branch-label', this.state.open ? 'state__branch-label--open' : 'state__branch-label--close'].join(' ');
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            { className: 'state__branch-label-icon' },
                            icon
                        ),
                        _react2.default.createElement(
                            'span',
                            { className: 'state__branch-label-name' },
                            _lodash2.default.last(path)
                        )
                    ),
                    _react2.default.createElement(_ButtonSet2.default, { dispatch: dispatch, state: state, path: path })
                ),
